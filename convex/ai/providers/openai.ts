...
export async function callOpenAI(
  ...
  if (!client) {
    console.warn("OpenAI API key not configured, falling back to default action");
    return {
      action: "rest",
      target: null,
      reasoning: "The tribe rests while awaiting guidance. (OpenAI API key not configured)",
    };
  }
